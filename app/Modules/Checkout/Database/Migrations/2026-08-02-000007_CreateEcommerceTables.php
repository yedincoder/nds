...
namespace App\Modules\Checkout\Database\Migrations;
...
class CreateEcommerceTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->createTable('carts', true, ['ENGINE' => 'InnoDB', 'CHARSET' => 'utf8mb4', 'COLLATE' => 'utf8mb4_general_ci']);
        ...
        $this->forge->createTable('cart_items', true, ['ENGINE' => 'InnoDB', 'CHARSET' => 'utf8mb4', 'COLLATE' => 'utf8mb4_general_ci']);
        ...
        $this->forge->addField([
            ...
            'payment_status' => ['type' => 'ENUM', 'constraint' => ['pending','paid','failed','refunded','cancelled'], 'default' => 'pending'],
            'subtotal' => ['type' => 'DECIMAL', 'constraint' => '15,2', 'default' => 0],
        ...
        $this->forge->createTable('orders', true, ['ENGINE' => 'InnoDB', 'CHARSET' => 'utf8mb4', 'COLLATE' => 'utf8mb4_general_ci']);
        ...
        $this->forge->createTable('order_items', true, ['ENGINE' => 'InnoDB', 'CHARSET' => 'utf8mb4', 'COLLATE' => 'utf8mb4_general_ci']);
        ...
        $this->forge->addUniqueKey('uuid');
        $this->forge->addKey('user_id');
        $this->forge->createTable('customer_addresses', true, ['ENGINE' => 'InnoDB', 'CHARSET' => 'utf8mb4', 'COLLATE' => 'utf8mb4_general_ci']);
    }
