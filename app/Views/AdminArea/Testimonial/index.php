...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-approved { background: #d4edda; color: #15803d; }
        .badge-rejected { background: #f8d7da; color: #dc3545; }
        .testimonial-item { cursor: pointer; }
        .testimonial-item:hover { background: rgba(230,92,0,0.1); }
        .testimonial-item img { max-width: 100%; border-radius: 50%; width: 60px; height: 60px; }
        .star-rating .star { color: #ffc107; }
    </style>
</head>
<body data-active="testimonial">
    <div class="shell d-flex">
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <div class="brand-logo"><i class="fas fa-quote-left"></i></div>
            ...
            <nav class="nav-section">
                ...
                <a class="nav-link active" href="/admin/testimonial"><i class="fas fa-quote-left"></i><span>Testimonials</span></a>
        ...
        <div class="main-content">
            ...
            <main class="content" style="padding: 30px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="section-title mb-0">Testimonials</h1>
                    <a href="/admin/testimonial/create" class="btn btn-primary"><i class="fas fa-plus"></i> Add Testimonial</a>
                </div>
                <div class="card">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?= esc($testimonial->customer_photo ?? '') ?>" alt="Photo" onerror="this.src='https://via.placeholder.com/40'" class="me-3">
                                                        <div>
                                                            <strong><?= esc($testimonial->customer_name) ?></strong>
                                                            <small class="text-muted"><?= esc($testimonial->customer_email ?? '') ?></small>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <span class="badge-status badge-<?= esc($testimonial->status ?? 'pending') ?>"><?= esc($testimonial->status ?? 'pending') ?></span
                                                </td>
                                                <td><?= esc($testimonial->created_at ?? '-') ?></td>
                                                <td>
                                                    <a href="/admin/testimonial/<?= esc($testimonial->id) ?>/edit" class="btn btn-sm btn-outline-primary">Edit</a
                                                    <a href="/admin/testimonial/<?= esc($testimonial->id) ?>/delete" class="btn btn-sm btn-outline-danger">Delete</a
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
