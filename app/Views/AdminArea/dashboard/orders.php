...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-completed { background: #d4edda; color: #15803d; }
    ...
    <div class="shell d-flex">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-section">
                ...
                <a class="nav-link active" href="/admin/orders"><i class="fas fa-shopping-cart"></i><span>Orders</span></a>
        ...
        <div class="main-content">
            ...
            <main class="content" style="padding: 30px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="section-title mb-0">Manage Orders</h1>
                </div>
                <div class="card">
                                    ...
                                    <?php if (!empty($orders)): ?>
                                        <?php foreach ($orders as $i => $order): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge-status badge-<?= esc($order->status ?? 'pending') ?>"><?= esc($order->status ?? 'pending') ?></span>
                                                </td>
