    ...
    <div class="shell d-flex">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-section">
                ...
                <a class="nav-link active" href="/admin/settings"><i class="fas fa-cog"></i><span>Settings</span></a>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="currency" value="IDR" placeholder="IDR">
                                    </div>
                                    <div class="mb-3">
