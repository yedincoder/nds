        ...
        <div class="main-content">
            ...
            <main class="content" style="padding: 30px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="section-title mb-0">Manage Services</h1>
                </div>
                <div class="card">
                                    ...
                                    <?php if (!empty($services)): ?>
                                        <?php foreach ($services as $i => $service): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <?php if (!empty($service->image)): ?>
                                                            <img src="<?= esc($service->image) ?>" alt="<?= esc($service->name) ?>" class="service-img me-3">
                                                        <?php endif; ?>
                                                ...
                                                <td>
                                                    <span class="badge-status badge-<?= esc($service->status ?? 'active') ?>"><?= esc($service->status ?? 'active') ?></span>
                                                </td>
