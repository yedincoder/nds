    ...
    <div class="shell d-flex">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-section">
                ...
                <a class="nav-link active" href="/admin/products"><i class="fas fa-box"></i><span>Products</span></a>
        ...
        <div class="main-content">
            ...
            <main class="content" style="padding: 30px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="section-title mb-0">Manage Products</h1>
                    <a href="/admin/products/create" class="btn btn-primary"><i class="fas fa-plus"></i> Add Product</a>
                </div>
                <div class="card">
                                    ...
                                    <?php if (!empty($products)): ?>
                                        <?php foreach ($products as $i => $product): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <?php if (!empty($product->image)): ?>
                                                            <img src="<?= esc($product->image) ?>" alt="<?= esc($product->name) ?>" class="product-img me-3">
                                                        <?php endif; ?>
                                                        <div>
                                                ...
                                                <td>
                                                    <span class="badge-status badge-<?= esc($product->status ?? 'active') ?>"><?= esc($product->status ?? 'active') ?></span>
                                                </td>
