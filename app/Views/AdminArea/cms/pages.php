        ...
        <div class="main-content">
            ...
            <main class="content" style="padding: 30px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="section-title mb-0">Manage Pages</h1>
                    <a href="/admin/cms/pages/create" class="btn btn-primary"><i class="fas fa-plus"></i> Add Page</a>
                </div>
                <div class="card">
                                    ...
                                    <?php if (!empty($pages)): ?>
                                        <?php foreach ($pages as $i => $page): ?>
                                            <tr>
                                                ...
                                                <td><?= esc($page->slug ?? '-') ?></td>
                                                <td>
                                                    <span class="badge-status badge-<?= esc($page->status ?? 'draft') ?>"><?= esc($page->status ?? 'draft') ?></span>
                                                </td>
                                                <td><?= esc($page->created_at ?? '-') ?></td>
                                                <td>
                                                    <a href="/admin/cms/pages/<?= esc($page->id) ?>/edit" class="btn btn-sm btn-outline-primary">Edit</a>
                                                    <a href="/admin/cms/pages/<?= esc($page->id) ?>/delete" class="btn btn-sm btn-outline-danger">Delete</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
